...
class ExitEntryRecord(models.Model):
    ...
    exit_date = models.DateTimeField('出监日期', null=True, blank=True)
    entry_date = models.DateTimeField('入监日期', null=True, blank=True)
    ...
    armed_police_face = models.CharField('武警人脸照片', max_length=512, blank=True, null=True)
