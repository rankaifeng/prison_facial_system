...
const PRISONS = [
    { id: 'P001', name: '分监区一', city: '北京' },
    { id: 'P002', name: '分监区二', city: '上海' },
    { id: 'P003', name: '分监区三', city: '广州' },
    { id: 'P004', name: '分监区四', city: '深圳' },
    { id: 'P005', name: '分监区五', city: '杭州' },
    { id: 'P006', name: '分监区六', city: '南京' },
    { id: 'P007', name: '分监区七', city: '武汉' }
];
const STATUSES = ['刑满释放', '外出就医', '外出教育', '离监探亲', '押回重审'];
const EXIT_REASONS = ['刑期满释放', '减刑释放', '假释', '特赦', '因病释放', '死亡', '逃脱', '保外就医'];

"刑满释放", "外出就医", "外出教育", "离监探亲", "押回重审"
