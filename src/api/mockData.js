...
const PRISONS = [
    { id: 'P001', name: '一监区', city: '北京' },
    { id: 'P002', name: '二监区', city: '上海' },
    { id: 'P003', name: '三监区', city: '广州' },
    { id: 'P004', name: '四监区', city: '深圳' },
    { id: 'P005', name: '五监区', city: '杭州' },
    { id: 'P006', name: '六监区', city: '南京' },
    { id: 'P007', name: '七监区', city: '武汉' }
];
