...
const PRISONS = [
  { id: 'P001', name: '北京第一监狱', city: '北京' },
  { id: 'P002', name: '上海浦东监狱', city: '上海' },
  { id: 'P003', name: '广州番禺监狱', city: '广州' },
  { id: 'P004', name: '深圳南山监狱', city: '深圳' },
  { id: 'P005', name: '杭州浙江监狱', city: '杭州' },
  { id: 'P006', name: '南京江苏监狱', city: '南京' },
  { id: 'P007', name: '武汉湖北监狱', city: '武汉' }
];
