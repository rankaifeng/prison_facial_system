...
export const ACCOUNT_ADD = '/prison_manage/account/account_add';
export const ACCOUNT_UPDATE = '/prison_manage/account/account_update';
export const ACCOUNT_DELETE = '/prison_manage/account/account_delete';
