...
//center: [114, 23], { name: '六监区', province: '广东', code: '440000', coordinates: [113.26, 23.13], totalCount: 510, workCount: 395 },
...
const PrisonMap = ({ realtimeData, isAdmin }) => {
  ...
  const mCont = [
    { name: '一监区', province: '四川', code: '510000', coordinates: [104.06, 30.67], totalCount: 0, yearlyExitCount: 0 },
    { name: '二监区', province: '云南', code: '530000', coordinates: [101.34, 25.04], totalCount: 0, yearlyExitCount: 0 },
    { name: '三监区', province: '贵州', code: '520000', coordinates: [106.71, 26.60], totalCount: 0, yearlyExitCount: 0 },
    { name: '四监区', province: '广西', code: '450000', coordinates: [108.33, 22.84], totalCount: 0, yearlyExitCount: 0 },
    ...
    const updatedCont = displayCont.map((item) => {
      ...
      .then(chinaData => {
        ...
        chart.on('click', (params) => {
          if ((params.seriesType === 'scatter' || params.seriesType === 'effectScatter') && params.name) {
