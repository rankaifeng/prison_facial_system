...
const PrisonMap = () => {
  ...
  const prisons = [
    ...
    { name: '分监区二', province: '云南', code: '530000', coordinates: [101.34, 25.04], totalCount: 382, workCount: 285 },
    { name: '分监区三', province: '贵州', code: '520000', coordinates: [106.71, 26.60], totalCount: 520, workCount: 410 },
    { name: '分监区四', province: '广西', code: '450000', coordinates: [108.33, 22.84], totalCount: 298, workCount: 220 },
